<form action="<?php echo e(url('/barang/import_ajax')); ?>" method="POST" id="form-import" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <a href="<?php echo e(asset('template_barang.xlsx')); ?>" class="btn btn-info btn-sm" download><i class="fa fa-file-excel"></i> Download</a>
...
</script><?php /**PATH C:\Users\user\Documents\2023\Advanced Web Programming\PWL_POS\resources\views/barang/import.blade.php ENDPATH**/ ?>