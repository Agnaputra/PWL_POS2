...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="<?php echo e(url('/')); ?>" class="h1"><b>Admin</b>LTE</a>
    </div>
    <div class="card-body">
      ...
      <form action="<?php echo e(url('login')); ?>" method="POST" id="form-login">
        ...
        <div>
          ...
          <div class="col-6">
            <a href="<?php echo e(route('register')); ?>" class="btn btn-secondary btn-block">Register</a>
          </div>
          <div class="col-6">
...
</html><?php /**PATH C:\Users\user\Documents\2023\Advanced Web Programming\PWL_POS\resources\views/auth/login.blade.php ENDPATH**/ ?>