<form action="<?php echo e(url('/kategori/ajax')); ?>" method="POST" id="form-add">
    <?php echo csrf_field(); ?>
...
</script><?php /**PATH C:\laragon\www\PWL_POS1\resources\views/kategori/create_ajax.blade.php ENDPATH**/ ?>